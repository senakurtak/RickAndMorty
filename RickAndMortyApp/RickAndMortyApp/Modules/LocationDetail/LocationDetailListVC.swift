...
class LocationDetailVC: BaseVC<LocationDetailVM> {
    ...
    func locationNameLabelSetUp() {
        ...
        locationNameLabel.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor,
    ...
    func locationTypeLabelSetUp() {
        ...
        locationTypeLabel.topAnchor.constraint(equalTo: locationNameLabel.bottomAnchor,
                                               constant: 50).isActive = true
        locationTypeLabel.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor,
                                                   constant: 20).isActive = true
        locationTypeLabel.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor,
                                                    constant: -20).isActive = true
    }
    ...
    func locationDimensionLabelSetUp() {
        ...
        locationDimensionLabel.topAnchor.constraint(equalTo: locationTypeLabel.bottomAnchor,
                                                    constant: 50).isActive = true
        locationDimensionLabel.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor,
                                                        constant: 20).isActive = true
        locationDimensionLabel.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor,
                                                         constant: -20).isActive = true
    }
